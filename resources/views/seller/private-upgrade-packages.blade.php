<x-main-layout>
    <section class="bg-gray-100 py-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-3xl font-bold text-gray-900">Upgrade Your Package</h1>
            <p class="mt-3 text-gray-600 text-lg">Choose a new package for <span class="font-semibold">{{ $advert->title }}</span> (£{{ number_format((float) $advert->price, 2) }})</p>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                ...
                <div class="bg-white border rounded p-8 shadow-sm hover:shadow-md transition flex flex-col">
                    ...
                    <div class="mt-8">
                        <a href="{{ route('seller.private.upgrade.checkout', [$advert, $level]) }}"
