...
<div class="flex h-screen overflow-hidden">
    ...
    >
        ...
        <nav class="flex-1 px-2 py-4 space-y-1 text-sm">
            ...
            {{-- Listing Reports --}}
            <a href="{{ route('admin.listing-reports.index') }}"
               class="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-700 {{ request()->routeIs('admin.listing-reports.*') ? 'bg-gray-700 text-white' : '' }}">
                ...
                <span x-show="sidebarOpen" class="whitespace-nowrap">Listing Reports</span>
            </a>
            ...
            <a href="{{ route('admin.maintenance.edit') }}"
               class="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-700 {{ request()->routeIs('admin.maintenance.*') ? 'bg-gray-700 text-white' : '' }}">
                ...
                <span x-show="sidebarOpen" class="whitespace-nowrap">Maintenance Mode</span>
            </a>
