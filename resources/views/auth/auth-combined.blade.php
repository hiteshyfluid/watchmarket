                ...
                <div class="bg-[#f7f7f7] border border-[#e4e4e4] p-8 lg:p-10">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4" autocomplete="off">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <input id="first_name" type="text" name="first_name" value="{{ old('first_name') }}" required placeholder="First Name *" autocomplete="off"
                                    class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                                <x-input-error :messages="$errors->get('first_name')" class="mt-2" />
                            </div>
                            <div>
                                <input id="last_name" type="text" name="last_name" value="{{ old('last_name') }}" required placeholder="Last Name *" autocomplete="off"
                                    class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                        ...
                        <div>
                            <input id="phone" type="text" name="phone" value="{{ old('phone') }}" required placeholder="Phone *" autocomplete="off"
                                class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                            <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                        </div>

                        <div>
                            <input id="address" type="text" name="address" value="{{ old('address') }}" required placeholder="Address *" autocomplete="off"
                                class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                            <x-input-error :messages="$errors->get('address')" class="mt-2" />
                        </div>

                        <div>
                            <input id="city" type="text" name="city" value="{{ old('city') }}" required placeholder="City *" autocomplete="off"
                                class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                            <x-input-error :messages="$errors->get('city')" class="mt-2" />
                        </div>

                        <div>
                            <input id="postal_code" type="text" name="postal_code" value="{{ old('postal_code') }}" required placeholder="Postal Code *" autocomplete="off"
                                class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                            <x-input-error :messages="$errors->get('postal_code')" class="mt-2" />
                        </div>

                        <div>
                            <select id="country" name="country" autocomplete="off" class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                        ...
                        <div>
                            <input id="register_email" type="email" name="email" value="{{ old('email') }}" required placeholder="Email address *" autocomplete="off"
                                class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                        </div>

                        <div class="relative">
                            <input id="register_password" type="password" name="password" required placeholder="Password *" autocomplete="new-password"
                                class="w-full h-11 border border-[#cfcfcf] bg-[#f7f7f7] px-4 pr-11 text-[16px] focus:outline-none focus:ring-1 focus:ring-black">
